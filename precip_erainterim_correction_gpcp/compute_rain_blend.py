...
fyear=1979
lyear=2018
cmt_indir = '/lustre/f2/dev/Raphael.Dussin/forcings/CMT_OM4p5'
...
for year in np.arange(fyear, lyear+1):
    dsprecip = xr.open_dataset(f'{cmt_indir}/precip_Blend_Dussin_{year}_OM4p5_conservative.nc')
    ...
    dsrain.to_netcdf(f'{cmt_indir}/rain_Blend_Dussin_{year}_OM4p5_conservative.nc',
