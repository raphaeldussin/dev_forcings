...
for year in np.arange(fyear, lyear+1):
    dsprecip = xr.open_dataset(f'{erainterim_indir}/precip_ERAinterim_{year}_OM4p5_conservative.nc')
    ...
    dsrain.to_netcdf(f'{erainterim_outdir}/rain_ERAinterim_{year}_OM4p5_conservative.nc',
